"""
Code adapted from: https://github.com/Deci-AI/super-gradients
"""
import importlib
...
class KDEzTrainer(EzTrainer):
    ...
    def init_model(self, params: Mapping, resume: bool, checkpoint_path: str = None):
        ...
        if teacher_checkpoint is not None:
            ...
            logger.warning("No teacher checkpoint provided, ensure you loaded them manually")
    ...
    def _load_checkpoint_to_model(self):
        ...
        super()._load_checkpoint_to_model()
